...
export async function POST(req: Request) {
  ...
  try {
    ...
    logger.error("Create offboarding record error:", { error: error instanceof Error ? error.message : String(error), stack: error instanceof Error ? error.stack : undefined });
