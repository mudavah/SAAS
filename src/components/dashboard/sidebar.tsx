...
const navItems = [
  ...
  { href: "/dashboard/ai/forecasts", label: "AI Forecasts", icon: TrendingUp },
  { href: "/dashboard/ai/insights", label: "AI Insights", icon: Lightbulb },
  { href: "/dashboard/ai/query", label: "Ask KaziFlow AI", icon: MessageSquare },
  { href: "/dashboard/ai/documents", label: "AI Documents", icon: FileText },
  { href: "/dashboard/ai/tasks", label: "AI Tasks", icon: CheckSquare },
  { href: "/dashboard/ai/history", label: "AI Activity", icon: History },
  { href: "/dashboard/automation", label: "Automation", icon: Workflow },
  { href: "/dashboard/automation/runs", label: "Automation Runs", icon: GitBranch },
